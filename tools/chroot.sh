...
main() {
    ...
    pacman -Sy
    pacman -S --noconfirm grub openssh sudo mesa gtkmm zsh xorg-xinit terminator i3 xorg-server git neovim ctags perl-tidy the_silver_searcher python2-neovim xsel gmrun diff-so-fancy docker zsh-theme-powerlevel9k awesome-terminal-fonts docker-compose pacman-contrib
